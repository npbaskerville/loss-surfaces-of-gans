...
# Execute code
python rmt_sigmaz_exp.py --kappa ${kappas[$(( ($PBS_ARRAY_INDEX-1)  ))]} --out $WORK/gan-loss-surfaces/rmt_results/vary_kappa/results_$(( ($PBS_ARRAY_INDEX-1))) --p 5 --q 5 --sigma 1.00000

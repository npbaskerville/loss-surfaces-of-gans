...
# Execute code
python rmt_sigmaz_exp.py --kappa ${kappas[$(( ($PBS_ARRAY_INDEX-1)  ))]} --out $WORK/gan-loss-surfaces/rmt_results/vary_kappa_variety_params/p10q10/results_$(( ($PBS_ARRAY_INDEX-1))) --p 10 --q 10 --sigma 1.00000

...
# Execute code
python rmt_kappa_exp.py --kappa ${kappas[$(( ($PBS_ARRAY_INDEX-1)  ))]} --out /work/jr19127/gan-loss-surfaces/rmt_results/vary_kappa/p3q5/results_$(( ($PBS_ARRAY_INDEX-1))) --p 3 --q 5 --sigma 1.00000
